...
public abstract class Property {
	...
	private static final String PROPERTIES_FILE = "/Cursotesteautomacao/target/config.properties";
	
	static{
		CHROME_DRIVE_PATH = new File("").getAbsolutePath() + "\\Cursotesteautomacao\\target\\chromedriver.exe";
		IE64_DRIVE_PATH = new File("").getAbsolutePath() + "\\Cursotesteautomacao\\target\\IEDriverServer.exe";
		FIREFOX_DRIVE_PATH = new File("").getAbsolutePath() + "\\Cursotesteautomacao\\target\\geckodriver.exe";
